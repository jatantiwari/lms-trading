...
const heroSlides = [
  ...
  {
    id: 2,
    image: '/ai-powered-device-concept.jpg',
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 pb-20 sm:pb-28 pt-32 md:pt-0">
          <div className="max-w-2xl space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Link href="/courses">
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground w-full sm:w-auto shadow-lg shadow-primary/30">
                  Start Learning Now
